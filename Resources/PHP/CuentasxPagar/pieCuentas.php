...
<footer class="footer">
  <li class="nav-item">
    <a  class="noborder w-100" href="/fitcoControl/Resources/PHP/Login/CerrarSesion.php" >
  ...
  <script src="/fitcoControl/Resources/js/CuentasxPagar/CuentasxPagar.js"></script>
