...
require $root . "/fitcoControl/Resources/PHP/DataBases/Conexion.php";
  ...
  $clt_telefono = $conn->real_escape_string($_POST['clt_telefono']);
  ...
  $query = "INSERT INTO ct_cliente(pk_cliente,nombreCliente,correoCliente,telefonoCliente,creditoCliente,fingresoCliente,colorCliente,prendasCliente,nosotrosCliente) VALUES('$clt_id','$clt_nombre','$clt_contacto','$clt_telefono','$clt_credito','$clt_fingreso','$clt_color','$clt_prendas','$clt_nosotros')";
