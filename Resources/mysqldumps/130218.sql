...
-- Tiempo de generación: 13-02-2018 a las 19:48:13
...
(13, 'Diseñadora', 'áfdkjshfkwje', 'jkdhkjsh', 0, '2018-02-13', '#000000', 1, '1', '1');
...
(72, '', 'q123', '1250.00', '2017-12-08', '8'),
(73, '', 'A234', '1234.00', '2017-11-23', '10'),
(74, '', 'A450', '3400.00', '2017-12-08', '7'),
(75, '', 'A900', '450.00', '2018-01-19', '9'),
(76, '', 'D213', '860.00', '2018-01-19', '12');
...
(1, 'Coputadora MAC', '2017-12-08', 'M123456789', 'Estefania Pinales', '2017-12-11', 'Nueva', '20000'),
(3, 'hola', '2017-12-08', '576576', 'estefania', '2017-12-12', 'nuevo', '10000');
...
(29, 72, '2017-12-07', 1250),
(30, 74, '2018-01-18', 150),
(31, 75, '2018-01-19', 300),
(32, 76, '2018-01-19', 750);
...
(6, 'Cliente2', 'Juan Quintero', '2018-02-14', '0000-00-00', '40', '30%', 100),
...
(21, 'produccion', 'prueba', 'pruebaproduccion@', 'produccion', 'produccion', 'produccion', 'produccion', 'Usuario', '0', '0', '1', '0', '0', '0', '0', '0'),
(22, 'Ventas', 'Ventas', 'ventas@', 'ventas', 'ventas', 'ventas', 'ventas', 'Usuario', '0', '0', '0', '0', '0', '0', '', ''),
(23, 'prueba', 'holahola', 'prueba@hdioksnmn', 'prueba', 'prueba', 'prueba', 'prueba', 'Usuario', '0', '0', '0', '0', '1', '1', '0', '0'),
(24, 'Deseñadora', 'dhjkh', 'jh', 'kj', 'hkj', 'h', 'kjhk', 'Administrador', '0', '0', '0', '0', '0', '0', '0', '0');
...
--
ALTER TABLE `ct_cobranza`
  MODIFY `pk_cobranza` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;
--
...
--
ALTER TABLE `ct_envios`
  MODIFY `pk_envios` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `ct_pagos`
  MODIFY `pk_pagos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
--
...
--
ALTER TABLE `usuarios`
  MODIFY `pk_usuario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
