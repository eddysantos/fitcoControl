...
-- Tiempo de generación: 21-02-2018 a las 17:28:58
...
(79, 'Maquila', 'A10', '230000.00', '2018-01-10', '2018-01-16', '7'),
(80, 'Bordado', 'A20', '345670.00', '2018-02-06', '2018-02-13', '11'),
(81, 'Bordado', 'A20', '245670.00', '2018-03-21', '2018-03-27', '12'),
(82, 'Flete', 'A20', '235000.00', '2018-04-18', '2018-04-20', '8'),
(83, 'Maquila', 'A40', '145670.00', '2018-01-23', '2018-01-25', '10'),
(84, 'Flete', 'A50', '342000.00', '2017-12-26', '2017-12-27', '9');
...
--
ALTER TABLE `ct_cobranza`
  MODIFY `pk_cobranza` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;
--
...
--
ALTER TABLE `ct_pagos`
  MODIFY `pk_pagos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
--
