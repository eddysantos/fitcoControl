...
-- Tiempo de generación: 24-04-2018 a las 21:10:52
...
(1, '22', 'Red', '1300', '#ff2600', '#FFFFFF', '2018-03-27 12:44:00', '2018-03-30 14:00:00'),
(70, '30', 'Cliente1', '100', '#fffb00', '#FFFFFF', '2018-04-18 08:00:00', '2018-04-18 18:00:00'),
(72, '25', 'Dos Banderas', '30', '#9437ff', '#FFFFFF', '2018-04-18 08:00:00', '2018-04-18 18:00:00'),
(73, '26', 'Carey', '500', '#ff8ad8', '#FFFFFF', '2018-03-28 08:00:00', '2018-03-28 18:00:00'),
(74, '22', 'Red', '300', '#ff2600', '#FFFFFF', '2018-04-11 08:00:00', '2018-04-11 18:00:00'),
(75, '24', 'Liberty', '200', '#73fdff', '#FFFFFF', '2018-03-28 08:00:00', '2018-04-01 18:00:00'),
(77, '25', 'Dos Banderas', '450', '#9437ff', '#FFFFFF', '2018-03-28 08:00:00', '2018-03-28 18:00:00'),
(80, '27', 'Diseñadora', '560', '#0433ff', '#FFFFFF', '2018-04-05 08:00:00', '2018-04-05 18:00:00');
...
CREATE TABLE `programacion` (
  ...
  `start` datetime NOT NULL,
  `end` datetime NOT NULL,
  `piezasRequeridas` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `programacion` (`pk_programacion`, `fk_cliente`, `start`, `end`, `piezasRequeridas`) VALUES
(2, '23', '2018-04-23 09:00:00', '2018-04-24 10:00:00', '2000');
...
--
ALTER TABLE `ct_produccion`
  MODIFY `pk_produccion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `ct_program`
--
ALTER TABLE `ct_program`
  MODIFY `pk_programacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=81;
--
...
--
ALTER TABLE `programacion`
  MODIFY `pk_programacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
