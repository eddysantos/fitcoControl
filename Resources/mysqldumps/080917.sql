...
-- Tiempo de generación: 08-09-2017 a las 22:54:18
...
(31, '', 'A777', '7777.00', '2017-09-07', '10 '),
(32, '', 'A888', '8888.00', '2017-09-08', '7 '),
...
(10, '8', '2017-09-07', '2017-09-07', 300, '60'),
(13, '11', '2017-09-07', '2017-09-12', 980, '50'),
(14, '9', '2017-09-07', '2017-09-22', 1100, '50'),
(19, '10 ', '2017-09-07', '2017-09-14', 1500, '30'),
...
--
ALTER TABLE `ct_cobranza`
  MODIFY `pk_cobranza` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
--
-- AUTO_INCREMENT de la tabla `ct_produccion`
--
ALTER TABLE `ct_produccion`
  MODIFY `pk_produccion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
