...
<h4 class="sub-grafica">GRAFICA CLIENTES NUEVOS</h4>
<div class="container border" style='border-radius:10px;margin-bottom:100px!important'>
  <div class="d-flex justify-content-between font12 m-0 py-3" style="border-radius:10px">
    <div class="">
      <a href="#mostrar_clientesNuevos" data-toggle="modal" class="rotate-link consultar ancla ml-3" style="font-size: larger;">
        <img src="/fitcoControl/Resources/iconos/003-analytics-2.svg" class="icon1 rotate-icon" style="width:30px;">
      </a>
    </div>
    <div class="">
      <select class="c-select efecto" id="cltNuevo_periodo">
        <option value="">Periodo</option>
        <option value="0" selected>Diario</option>
        <option value="1">Semanal</option>
        <option value="2">Mensual</option>
      </select>
      <div id="dates_cltNuevo_chart" class='d-inline'>
        <div class="d-inline">
      ...
      <a href="#" id="cltNuevo_load" class="rotate-link consultar ancla reload-cltNuevo ml-4" style="font-size: larger; text-decoration:none">
        <img src="/fitcoControl/Resources/iconos/refresh.svg" class="icon1 rotate-icon" style="width:30px;">
      </a>
    </div>
  </div>
  <div id="g-cltNuevo" style="margin-top:100px"></div>
</div>
...
<script src="/fitcoControl/Ubicaciones/Comunicaciones/Estadisticas/js/acciones_nuevoCliente.js" charset="utf-8"></script>
<?php
require $root . '/fitcoControl/Ubicaciones/Comunicaciones/Estadisticas/actions/footer.php';
require $root . '/fitcoControl/Ubicaciones/Comunicaciones/Estadisticas/modales/clientesNuevos.php';
?>
