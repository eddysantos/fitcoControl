...
$system_callback = [];
$query = "SELECT * FROM Utilidades  ORDER BY fecha DESC";
...
while ($row = $rslt->fetch_assoc()) {
  ...
  $system_callback['data'] .="<tr class='row text-center m-0 borderojo'>
    ...
    <td class='col-md-3'>$ingresos</td>
    <td class='col-md-3'>$egresos</td>
      <td class='col-md-2 text-right'>
         <a href='#editar_utilidades' db-id='$id' class='edit_utilidades'>
