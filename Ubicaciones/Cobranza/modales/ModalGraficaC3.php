      ...
      <div class="modal-body pt-0">
        <div class="row submenuMed">
          <ul class="nav nav-pills nav-fill" id="selectGrafica" style="width: 100%;">
            <li class="nav-item">
              <a class="nav-link consultar" id="submenuchico" accion="semanalTes">Grafica Semanal</a>
            </li>
            <li class="nav-item">
              <a class="nav-link consultar" id="submenuchico" accion="mensualTes">Grafica Mensual</a>
            </li>
          </ul>
        </div>

        <div class="mt-5" id="graficasemanalTes" style="display:none"></div>
        <div class="mt-5" id="graficamensualTes" style="display:none"></div>
      </div>
    </div>
  </div>
</div>
