...
switch ($data['period']) {
  case 0:
    $period = 'DATE(co.vencimientoCobranza)';
    break;

  case 1:
    $period = "WEEK(co.vencimientoCobranza, 1)";
    break;

  case 2:
    $period = "MONTH(co.vencimientoCobranza)";
    break;
...
// $and_where = "";
$and_where = "WHERE co.vencimientoCobranza BETWEEN ? AND ?";

$query = "SELECT $period AS agrupamiento,
co.vencimientoCobranza AS fecha,
SUM(co.importeCobranza) AS total,
