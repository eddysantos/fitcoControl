...
>>>>>>> origin/Dev
  ...
  <div id="nav_wrap" class="sticky">
    ...
    <ul class="nav nav-pills nav-fill" id="selecTipoPoliza">
      <li class="nav-item">
        <a href="/fitcoControl/Ubicaciones/Produccion/produccion.php" class="w-95">PRODUCCION</a>
      </li>
      <li class="nav-item">
        <a href="/fitcoControl/Ubicaciones/Cobranza/cobranza.php" class="w-95">COBRANZA</a>
      </li>
      <li class="nav-item">
        <a href="/fitcoControl/Ubicaciones/Clientes/Clientes.php" class="w-95">CLIENTES</a>
      </li>
      <li class="nav-item">
