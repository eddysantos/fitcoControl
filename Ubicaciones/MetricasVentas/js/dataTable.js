$(document).ready(function() {
  ...
  var listar = function(){
    var table = $('#db_cobranza').DataTable({
      ...
      "ajax":{
        "method": "POST",
        "url": "/fitcoControl/Resources/PHP/Cobranza/DataTable/listar.php"
      },
      "columns":[
...
function clientSelector(){
  ...
  $('#NuevoRegistroCobranza').click(function(){
    ...
    if (validacion) {
      ...
      $.ajax({
        method: 'POST',
        url: '/fitcoControl/Resources/PHP/Cobranza/DataTable/AgregarCobranza.php',
        data:{
 ...
 // *************************//
  ...
  var mostrar = function(pk_cobranza){
    if (!/^([0-9])*$/.test(pk_cobranza)) {
      ...
      $.ajax({
        url:"/fitcoControl/Resources/PHP/Cobranza/DataTable/MostrarCobranza.php",
        method: "POST",
        dataType: "json",
  ...
  $('.ActualizarDcobranza').click(function(){
    ...
    $.ajax({
      method:'POST',
      dataType: "json",
      url:'/fitcoControl/Resources/PHP/Cobranza/DataTable/EditarDatosCobranza.php',
      data: {
        mcbz_id: idCobranza,
  ...
  var eliminar = function (pk_cobranza) {
    ...
    function(isConfirm) {
      if (isConfirm) {
        $.ajax({
          method: 'POST',
          url: '/fitcoControl/Resources/PHP/Cobranza/DataTable/eliminar.php',
          data: {pk_cobranza: pk_cobranza},
