      ...
      <div class="modal-body">
        <form id="formAgregar">
          <table class="table">
            ...
            <tr class="row m20">
              <td class="col-md-6 input-effect p-0">
                <input class="modal-efecto-17 has-content popup-input w-100 border-0" id="_cliente" type="text" id-display="#popup-display-listaClientesCal" action="listaClientes" db-id="" autocomplete="off">
