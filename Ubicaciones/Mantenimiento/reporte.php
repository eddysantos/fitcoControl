...
<?php if ($pro_miVer == 1 || $admin): ?>
  <div class="m-5">
    <a href="/fitcoControl/Ubicaciones/Mantenimiento/Mantenimiento.php" class="consultar"><img style="width: 100px;" src='/fitcoControl/Resources/iconos/logoFitco.png'></a>
  </div>
    ...
    <table class="table table-bordered">
      <thead>
        <tr class='row m-0 encabezado text-center'>
          <td class='col-md-6'><p>Datos de Mantenimiento / Inversion</p></td>
          <td class='col-md-6'><p>Datos de la Compra / Gasto </p></td>
        </tr>
      </thead>
      <tbody id="mostrarPagado" class="font12">
        <tr>
