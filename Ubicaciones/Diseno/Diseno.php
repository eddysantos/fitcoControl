...
<div class="container border" style='border-radius:10px;margin-top:8rem!important'>
  <div class="d-flex justify-content-between font12 m-0 py-3" style="border-radius:10px">
    <div class="">
      <a href="#RegistrosDiseno" data-toggle="modal" class="rotate-link consultar ancla ml-3" style="font-size: larger;">
        <img src="/fitcoControl/Resources/iconos/003-analytics-2.svg" class="icon1 rotate-icon" style="width:30px;">
      </a>
    </div>
    <div class="">
      <select class="c-select efecto" id="dis_periodo">
        <option value="">Periodo</option>
        <option value="0" selected>Diario</option>
        <option value="1">Semanal</option>
        <option value="2">Mensual</option>
      </select>
      <div id="dates_dis_chart" class='d-inline'>
        <div class="d-inline">
      ...
      <a href="#" id="dis_load" class="rotate-link consultar ancla reload-chart ml-4" style="font-size: larger; text-decoration:none">
        <img src="/fitcoControl/Resources/iconos/refresh.svg" class="icon1 rotate-icon" style="width:30px;">
      </a>
    </div>
  </div>
  <div id="g-diseno" style="margin-top:100px"></div>
</div>


<?php
require $root . '/fitcoControl/Ubicaciones/Diseno/modales/mostrar_registros.php';
require $root . '/fitcoControl/Ubicaciones/Diseno/modales/editar.php';
require $root . '/fitcoControl/Ubicaciones/Diseno/actions/footer.php';
?>
